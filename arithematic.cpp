...
// #wap that keeps asking the user to input a number.add all the numbers togheter and stop asking when the user enter 0. finally print the total sum.
// int store=0,inp;
// while(1){
...
//   }
//   else{
//     cout<<"sum of previous enter value is="<<store;
//     break;
//   }
// }
